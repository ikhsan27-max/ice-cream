...
class _MenuState extends State<Menu> with SingleTickerProviderStateMixin {
  ...
  final List<String> _categories = [
    'All', 'Popular', 'New', 'Classic', 'Special'
  ];
  ...
  List<Map<String, String>> getFilteredIceCreams() {
    if (_selectedIndex == 0) {
      ...
      return flavors.where((flavor) => 
        flavor['category'] == _categories[_selectedIndex]
      ).toList();
    }
  }
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Special promo activated! Get 10% off!'),
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              _selectedIndex == 0 ? "Most Popular" : _categories[_selectedIndex],
                              style: GoogleFonts.poppins(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                              ),
                            ...
                            TextButton.icon(
                              icon: const Icon(Icons.sort, size: 16, color: Colors.pink),
                              label: Text(
                                "Sort",
                                style: GoogleFonts.poppins(
                                  color: Colors.pink,
